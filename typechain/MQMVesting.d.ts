...
interface MQMVestingInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getWithdrawContractAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getWithdrawContractAmountSubFrozenWalletAllocation",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class MQMVesting extends Contract {
  ...
  functions: {
    ...
    getWithdrawContractAmount(overrides?: CallOverrides): Promise<[BigNumber]>;

    "getWithdrawContractAmount()"(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    getWithdrawContractAmountSubFrozenWalletAllocation(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
